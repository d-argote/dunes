    ...
    <>
      ...
      <nav className="hidden md:flex w-[240px] h-screen fixed left-0 top-0 border-r border-outline-variant bg-surface-container-low flex-col py-2 z-50">
        ...
        <div className="px-6 mb-8 mt-6">
          <h1 className="font-brand text-5xl font-bold tracking-[0.08em] text-primary uppercase leading-none">
            DUNES
          </h1>
          <p className="font-body text-xs text-on-surface-variant uppercase tracking-widest mt-2 font-semibold">
            Admin Suite 2026
          </p>
        </div>
      ...
      <header className="h-16 sticky top-0 z-40 flex justify-between items-center px-6 bg-surface/80 backdrop-blur-xl border-b border-outline-variant/30">
        <div className="flex items-center gap-2">
          <span className="font-brand text-sm font-semibold text-on-surface-variant tracking-widest uppercase">
            DUNES
          </span>
        ...
        {navigation.slice(0, 4).map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className="font-body text-[10px] font-semibold tracking-widest uppercase mt-1">
                {item.label}
              </span>
            </Link>
          );
